...
class Mammal(Animal):
    def __init__(self, birthType="born alive", appearance= "hair or fur", blooded = "Warm Blooded", nurseYoung = True):
        Animal.__init__(self, birthtype = "Unknown", appearance = "Unknown", blooded="Unknown")
...
class Reptile(Animal):
    def __init__(self, birthType="born in an egg or born alive", apperance= "dry scales", blooded = "Cold blooded"):
        Animal.__init__(self, birthday, apppearance, blooded)
